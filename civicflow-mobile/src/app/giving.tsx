...
/**
 * CORE-GIVE-L — My Giving (§38). Member self-service only: Give Now,
 * recurring management, pledges, history, statements. Checkout always
 * happens in the SYSTEM BROWSER (§64 — card data never touches the app);
 * failure copy never implies debt (§16).
 */
export default function GivingScreen() {
  ...
  return (
    <>
      <Stack.Screen options={{ title: enabled?.terminology ?? 'Giving' }} />
        ...
        >
          ...
          {!loading && summary && !summary.enabled ? (
            <ThemedText type="small" themeColor="textSecondary" style={styles.empty}>
              This organization has not enabled online giving.
            </ThemedText>
          ) : null}
