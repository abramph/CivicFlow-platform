...
$contact_items = [
	[
		...
		'value' => cf_mod( 'contact_email', 'hello@civicflowapp.com' ),
		'icon'  => '<path d="M4 4h16c1.1 0 2 .9 2 2v12c0 1.1-.9 2-2 2H4c-1.1 0-2-.9-2-2V6c0-1.1.9-2 2-2z"/><polyline points="22,6 12,13 2,6"/>',
	],
	[
		'label' => __( 'Call us', 'civicflow' ),
		'value' => cf_mod( 'contact_phone', '1-800-CIVICFLOW' ),
	...
	[
		...
		'value' => __( 'Nonprofits · Civic orgs · Churches · Associations · Advocacy groups', 'civicflow' ),
					...
					<div class="form-row">
						<div class="field">
							...
							<select id="cf-type" name="cf_type">
								...
								<option value="nonprofit"><?php esc_html_e( 'Nonprofit', 'civicflow' ); ?></option>
								<option value="church"><?php esc_html_e( 'Church / religious organization', 'civicflow' ); ?></option>
								<option value="civic"><?php esc_html_e( 'Civic association', 'civicflow' ); ?></option>
								<option value="professional"><?php esc_html_e( 'Professional association', 'civicflow' ); ?></option>
								<option value="advocacy"><?php esc_html_e( 'Advocacy group', 'civicflow' ); ?></option>
								<option value="other"><?php esc_html_e( 'Other community organization', 'civicflow' ); ?></option>
							</select>
						</div>
						<div class="field">
