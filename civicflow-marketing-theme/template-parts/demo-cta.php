...
<section id="demo-cta" aria-labelledby="demo-heading">
	<div class="container">
		<h2 id="demo-heading"><?php echo esc_html( cf_mod( 'cta_heading', 'See CivicFlow in action' ) ); ?></h2>
		<p><?php echo esc_html( cf_mod( 'cta_subtext', 'Book a free 30-minute demo and we\'ll walk you through how CivicFlow can work for your specific organization type and size.' ) ); ?></p>
		<div class="demo-btns">
			...
			<a href="https://app.civicflowapp.com/signup" class="btn btn-outline-white" target="_blank" rel="noopener">
