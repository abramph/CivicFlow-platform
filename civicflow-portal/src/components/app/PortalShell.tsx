      ...
      <div className="mx-auto flex min-h-screen max-w-[1600px]">
        <aside className="hidden w-72 border-r border-slate-200 bg-white lg:block">
          ...
          <nav className="space-y-1 px-4 py-5">
            ...
            {canSeePlatformAdmin ? (
              <Link
                ...
                className={`block rounded-xl px-4 py-2.5 text-sm font-semibold transition ${
                  ...
                  !pathname.startsWith("/admin/platform/sms") &&
                  !pathname.startsWith("/admin/platform/whatsapp")
            ...
            {canSeePlatformAdmin ? (
              <Link
                href="/admin/platform/whatsapp"
                className={`block rounded-xl px-4 py-2.5 text-sm font-semibold transition ${
                  isActive(pathname, "/admin/platform/whatsapp")
                    ? "bg-slate-900 text-white shadow-sm"
                    : "text-slate-800 hover:bg-slate-100"
                }`}
              >
