...
export function PaymentLinkOfflineReportActions({ reportId }: { reportId: string }) {
  ...
  async function approve() {
    ...
    setError(null);
    try {
      const response = await fetch(`/api/admin/payment-link-reports/${reportId}/approve`, {
        method: "POST",
  ...
  async function reject() {
    ...
    setError(null);
    try {
      const response = await fetch(`/api/admin/payment-link-reports/${reportId}/reject`, {
        method: "POST",
        headers: { "Content-Type": "application/json" },
