...
export function CommunicationCampaignForm({ categories }: { categories: Option[] }) {
  ...
  return (
    <form className="space-y-5" onSubmit={submit}>
      ...
      <button disabled={saving} className="rounded-lg bg-emerald-700 px-4 py-2 text-sm font-semibold text-white hover:bg-emerald-800 disabled:bg-slate-400">{saving ? "Saving..." : form.sendNow ? "Send Communication" : "Save Draft"}</button>
    </form>
  );
}
