...
import { buildFinancialReportData, FINANCIAL_COLUMNS } from "@/lib/labs/pta/volunteer-hours/reports/financial";
...
/** GET — Report E: Purchased-Hours & Financial Report, real .xlsx download.
 * Same pta:volunteer-financial-reports:view gate as the JSON route. */
export async function GET(request: Request, { params }: { params: Promise<{ periodId: string }> }) {
  return withApiErrorHandling(async () => {
    ...
    const buffer = await buildVolunteerReportWorkbook(data, FINANCIAL_COLUMNS);
    ...
    await createAuditEvent({
      ...
      entityId: periodId,
      metadata: { reportType: "financial", filters: url.search },
    });
