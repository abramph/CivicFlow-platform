...
import { buildEventHoursReportData } from "@/lib/labs/pta/volunteer-hours/reports/event-hours";
import { parseVolunteerReportFilters, resolveGeneratedByName } from "@/lib/labs/pta/volunteer-hours/reports/shared";

/** GET — Report C: Event Volunteer-Hours Report, on-screen JSON (spec §11). */
