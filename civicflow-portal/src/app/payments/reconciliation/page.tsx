...
export default async function PaymentReconciliationPage() {
  ...
  return (
    <main className="space-y-6">
      ...
      <SectionCard title="Manual Electronic Payment Entry" description="For Zelle, Cash App, Venmo, PayPal, and Stripe payments verified outside CivicFlow, paste a small CSV and continue to review/post.">
