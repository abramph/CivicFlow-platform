  ...
  return (
    <main className="space-y-6">
      <PageHeader
        ...
        actions={[
          { href: `/expenditures/${row.id}/edit`, label: "Edit Expenditure", tone: "primary" },
      ...
      <SectionCard title="Payment and Attribution" description="Payment, reference, campaign, and event details.">
